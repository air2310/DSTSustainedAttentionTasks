...
% load([direct.data 'BEHAVE_10-Dec-2021 11-30'])
load([direct.data 'BEHAVE_12-Dec-2021 15-19.mat'])
...
for ii_measure = 1:length(twisefields)
    ...
    plot(1:num_splits, mean(Twise.(twisefields{ii_measure})([1 3:5],:),1), '-o', 'color', colors(1,:), 'linewidth', 2)% 'facecolor', 'k')
